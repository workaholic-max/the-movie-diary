...
const WatchedStatusIcon = (props) => (
  <svg className="gl-icon gl-icon--watched" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      fill="currentColor"
...
WatchedStatusIcon.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  viewBox: PropTypes.string,
};

WatchedStatusIcon.defaultProps = {
  width: 24,
  height: 24,
  viewBox: '0 0 256 256',
};

export default WatchedStatusIcon;
